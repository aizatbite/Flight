<%-- 
    Document   : payment
    Created on : 26 Mar 2024, 4:30:16 pm
    Author     : shafiq
--%>
...
<html lang="en" >
    ...
    <head>
        ...
        <link rel="canonical" href="https://codepen.io/quinlo/pen/YONMEa">
    ...
    <body translate="no">
        <div class="payment-title">
            ...
            %>
                <h1>Payment Information for booking Id <%= bookingId%></h1>
        </div>
        ...
        <form action="insertpayment" method="post">
            <div class="form-container">
                <input id="bookingId" maxlength="20" name="bookingId" type="hidden" value="4">

                <div class="field-container">
                    <label for="amount">Amount</label>
                    <input id="amount" maxlength="20" name="amount" type="text">
                </div>
                <div class="field-container">
